...
### 2. 새 아이콘이 반영된 APK/AAB 재빌드

필요한 이유:

- 기존 APK/AAB는 아이콘 교체 전에 만들어진 빌드다. Play 등록 이미지와 앱 설치 아이콘을 완전히 맞추려면 재빌드가 필요하다.
...
- EAS preview APK build 성공
- EAS production AAB build 성공
- 새 artifact를 `02_최종본`에 다시 저장

### 3. 실제 기기 스크린샷 교체 여부 결정
...
### 5. Google Play Console 내부 테스트 제출
